...
namespace codeDomTest1
{
    class Program
    {
        ...
        {            
            ...
            {
                System.Diagnostics.Process.Start(filename);//执行
            }
        ...
        /// 生成源代码
        /// </summary>
        /// <param name="nspace">源代码描述信息</param>
        /// <returns>所生成源代码文本</returns>
        ...
        /// 编译源代码
        /// </summary>
        /// <param name="nspace">源代码</param>
        /// <param name="filename">所编译的文件名称</param>
